...
TimeZone::Register.country "AD", "Andorra" do |c|
  c.timezone "Europe/Andorra", 85, 2, 91, 60
end
TimeZone::Register.country "AE", "United Arab Emirates" do |c|
  c.timezone "Asia/Dubai", 253, 10, 553, 10
end
TimeZone::Register.country "AF", "Afghanistan" do |c|
  c.timezone "Asia/Kabul", 2071, 60, 346, 5
end
TimeZone::Register.country "AG", "Antigua & Barbuda" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "AI", "Anguilla" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "AL", "Albania" do |c|
  c.timezone "Europe/Tirane", 124, 3, 119, 6
end
TimeZone::Register.country "AM", "Armenia" do |c|
  c.timezone "Asia/Yerevan", 2411, 60, 89, 2
end
TimeZone::Register.country "AO", "Angola" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "AQ", "Antarctica" do |c|
...
TimeZone::Register.country "AR", "Argentina" do |c|
...
TimeZone::Register.country "AS", "Samoa (American)" do |c|
  c.timezone "Pacific/Pago_Pago", -214, 15, -1707, 10, "Samoa, Midway"
end
TimeZone::Register.country "AT", "Austria" do |c|
  c.timezone "Europe/Vienna", 2893, 60, 49, 3
end
TimeZone::Register.country "AU", "Australia" do |c|
...
TimeZone::Register.country "AW", "Aruba" do |c|
  c.timezone "America/Curacao", 731, 60, -69, 1
end
TimeZone::Register.country "AX", "Åland Islands" do |c|
  c.timezone "Europe/Helsinki", 361, 6, 749, 30
end
TimeZone::Register.country "AZ", "Azerbaijan" do |c|
  c.timezone "Asia/Baku", 2423, 60, 997, 20
end
TimeZone::Register.country "BA", "Bosnia & Herzegovina" do |c|
  c.timezone "Europe/Belgrade", 269, 6, 41, 2
end
TimeZone::Register.country "BB", "Barbados" do |c|
  c.timezone "America/Barbados", 131, 10, -3577, 60
end
TimeZone::Register.country "BD", "Bangladesh" do |c|
  c.timezone "Asia/Dhaka", 1423, 60, 1085, 12
end
TimeZone::Register.country "BE", "Belgium" do |c|
  c.timezone "Europe/Brussels", 305, 6, 13, 3
end
TimeZone::Register.country "BF", "Burkina Faso" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "BG", "Bulgaria" do |c|
  c.timezone "Europe/Sofia", 2561, 60, 1399, 60
end
TimeZone::Register.country "BH", "Bahrain" do |c|
  c.timezone "Asia/Qatar", 1517, 60, 773, 15
end
TimeZone::Register.country "BI", "Burundi" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
TimeZone::Register.country "BJ", "Benin" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "BL", "St Barthelemy" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "BM", "Bermuda" do |c|
  c.timezone "Atlantic/Bermuda", 1937, 60, -1943, 30
end
TimeZone::Register.country "BN", "Brunei" do |c|
  c.timezone "Asia/Brunei", 74, 15, 1379, 12
end
TimeZone::Register.country "BO", "Bolivia" do |c|
  c.timezone "America/La_Paz", -33, 2, -1363, 20
end
TimeZone::Register.country "BQ", "Caribbean NL" do |c|
  c.timezone "America/Curacao", 731, 60, -69, 1
end
TimeZone::Register.country "BR", "Brazil" do |c|
...
TimeZone::Register.country "BS", "Bahamas" do |c|
  c.timezone "America/Nassau", 301, 12, -1547, 20
end
TimeZone::Register.country "BT", "Bhutan" do |c|
  c.timezone "Asia/Thimphu", 412, 15, 1793, 20
end
TimeZone::Register.country "BV", "Bouvet Island" do |c|
end
TimeZone::Register.country "BW", "Botswana" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
TimeZone::Register.country "BY", "Belarus" do |c|
  c.timezone "Europe/Minsk", 539, 10, 827, 30
end
TimeZone::Register.country "BZ", "Belize" do |c|
  c.timezone "America/Belize", 35, 2, -441, 5
end
TimeZone::Register.country "CA", "Canada" do |c|
...
TimeZone::Register.country "CC", "Cocos (Keeling) Islands" do |c|
  c.timezone "Indian/Cocos", -73, 6, 1163, 12
end
TimeZone::Register.country "CD", "Congo (Dem. Rep.)" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "CF", "Central African Rep." do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "CG", "Congo (Rep.)" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "CH", "Switzerland" do |c|
  c.timezone "Europe/Zurich", 2843, 60, 128, 15, "Swiss time"
end
TimeZone::Register.country "CI", "Côte d'Ivoire" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "CK", "Cook Islands" do |c|
  c.timezone "Pacific/Rarotonga", -637, 30, -4793, 30
end
TimeZone::Register.country "CL", "Chile" do |c|
...
TimeZone::Register.country "CM", "Cameroon" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "CN", "China" do |c|
  c.timezone "Asia/Shanghai", 937, 30, 1822, 15, "Beijing Time"
  c.timezone "Asia/Urumqi", 219, 5, 1051, 12, "Xinjiang Time"
end
TimeZone::Register.country "CO", "Colombia" do |c|
  c.timezone "America/Bogota", 23, 5, -889, 12
end
TimeZone::Register.country "CR", "Costa Rica" do |c|
  c.timezone "America/Costa_Rica", 149, 15, -1009, 12
end
TimeZone::Register.country "CU", "Cuba" do |c|
  c.timezone "America/Havana", 347, 15, -2471, 30
end
TimeZone::Register.country "CV", "Cape Verde" do |c|
  c.timezone "Atlantic/Cape_Verde", 179, 12, -1411, 60
end
TimeZone::Register.country "CW", "Curaçao" do |c|
  c.timezone "America/Curacao", 731, 60, -69, 1
end
TimeZone::Register.country "CX", "Christmas Island" do |c|
  c.timezone "Indian/Christmas", -125, 12, 6343, 60
end
TimeZone::Register.country "CY", "Cyprus" do |c|
  c.timezone "Asia/Nicosia", 211, 6, 1001, 30, "Cyprus (most areas)"
  c.timezone "Asia/Famagusta", 2107, 60, 679, 20, "Northern Cyprus"
end
TimeZone::Register.country "CZ", "Czech Republic" do |c|
  c.timezone "Europe/Prague", 601, 12, 433, 30
end
TimeZone::Register.country "DE", "Germany" do |c|
  c.timezone "Europe/Berlin", 105, 2, 401, 30, "Germany (most areas)"
  c.timezone "Europe/Zurich", 2843, 60, 128, 15, "Swiss time"
end
TimeZone::Register.country "DJ", "Djibouti" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "DK", "Denmark" do |c|
  c.timezone "Europe/Copenhagen", 167, 3, 151, 12
end
TimeZone::Register.country "DM", "Dominica" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "DO", "Dominican Republic" do |c|
  c.timezone "America/Santo_Domingo", 277, 15, -699, 10
end
TimeZone::Register.country "DZ", "Algeria" do |c|
  c.timezone "Africa/Algiers", 2207, 60, 61, 20
end
TimeZone::Register.country "EC", "Ecuador" do |c|
  c.timezone "America/Guayaquil", -13, 6, -479, 6, "Ecuador (mainland)"
  c.timezone "Pacific/Galapagos", -9, 10, -448, 5, "Galápagos Islands"
end
TimeZone::Register.country "EE", "Estonia" do |c|
  c.timezone "Europe/Tallinn", 713, 12, 99, 4
end
TimeZone::Register.country "EG", "Egypt" do |c|
  c.timezone "Africa/Cairo", 601, 20, 125, 4
end
TimeZone::Register.country "EH", "Western Sahara" do |c|
  c.timezone "Africa/El_Aaiun", 543, 20, -66, 5
end
TimeZone::Register.country "ER", "Eritrea" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "ES", "Spain" do |c|
...
TimeZone::Register.country "ET", "Ethiopia" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "FI", "Finland" do |c|
  c.timezone "Europe/Helsinki", 361, 6, 749, 30
end
TimeZone::Register.country "FJ", "Fiji" do |c|
  c.timezone "Pacific/Fiji", -272, 15, 2141, 12
end
TimeZone::Register.country "FK", "Falkland Islands" do |c|
  c.timezone "Atlantic/Stanley", -517, 10, -1157, 20
end
TimeZone::Register.country "FM", "Micronesia" do |c|
...
TimeZone::Register.country "FO", "Faroe Islands" do |c|
  c.timezone "Atlantic/Faroe", 3721, 60, -203, 30
end
TimeZone::Register.country "FR", "France" do |c|
  c.timezone "Europe/Paris", 733, 15, 7, 3
end
TimeZone::Register.country "GA", "Gabon" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "GB", "Britain (UK)" do |c|
  c.timezone "Europe/London", 6181, 120, -451, 3600
end
TimeZone::Register.country "GD", "Grenada" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "GE", "Georgia" do |c|
  c.timezone "Asia/Tbilisi", 2503, 60, 2689, 60
end
TimeZone::Register.country "GF", "French Guiana" do |c|
  c.timezone "America/Cayenne", 74, 15, -157, 3
end
TimeZone::Register.country "GG", "Guernsey" do |c|
  c.timezone "Europe/London", 6181, 120, -451, 3600
end
TimeZone::Register.country "GH", "Ghana" do |c|
  c.timezone "Africa/Accra", 111, 20, -13, 60
end
TimeZone::Register.country "GI", "Gibraltar" do |c|
  c.timezone "Europe/Gibraltar", 542, 15, -107, 20
end
TimeZone::Register.country "GL", "Greenland" do |c|
...
TimeZone::Register.country "GM", "Gambia" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "GN", "Guinea" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "GP", "Guadeloupe" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "GQ", "Equatorial Guinea" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "GR", "Greece" do |c|
  c.timezone "Europe/Athens", 1139, 30, 1423, 60
end
TimeZone::Register.country "GS", "South Georgia & the South Sandwich Islands" do |c|
  c.timezone "Atlantic/South_Georgia", -814, 15, -548, 15
end
TimeZone::Register.country "GT", "Guatemala" do |c|
  c.timezone "America/Guatemala", 439, 30, -5431, 60
end
TimeZone::Register.country "GU", "Guam" do |c|
  c.timezone "Pacific/Guam", 202, 15, 579, 4
end
TimeZone::Register.country "GW", "Guinea-Bissau" do |c|
  c.timezone "Africa/Bissau", 237, 20, -187, 12
end
TimeZone::Register.country "GY", "Guyana" do |c|
  c.timezone "America/Guyana", 34, 5, -349, 6
end
TimeZone::Register.country "HK", "Hong Kong" do |c|
  c.timezone "Asia/Hong_Kong", 1337, 60, 2283, 20
end
TimeZone::Register.country "HM", "Heard Island & McDonald Islands" do |c|
end
TimeZone::Register.country "HN", "Honduras" do |c|
  c.timezone "America/Tegucigalpa", 141, 10, -5233, 60
end
TimeZone::Register.country "HR", "Croatia" do |c|
  c.timezone "Europe/Belgrade", 269, 6, 41, 2
end
TimeZone::Register.country "HT", "Haiti" do |c|
  c.timezone "America/Port-au-Prince", 278, 15, -217, 3
end
TimeZone::Register.country "HU", "Hungary" do |c|
  c.timezone "Europe/Budapest", 95, 2, 229, 12
end
TimeZone::Register.country "ID", "Indonesia" do |c|
...
TimeZone::Register.country "IE", "Ireland" do |c|
  c.timezone "Europe/Dublin", 160, 3, -25, 4
end
TimeZone::Register.country "IL", "Israel" do |c|
  c.timezone "Asia/Jerusalem", 11441, 360, 63403, 1800
end
TimeZone::Register.country "IM", "Isle of Man" do |c|
  c.timezone "Europe/London", 6181, 120, -451, 3600
end
TimeZone::Register.country "IN", "India" do |c|
  c.timezone "Asia/Kolkata", 338, 15, 2651, 30
end
TimeZone::Register.country "IO", "British Indian Ocean Territory" do |c|
  c.timezone "Indian/Chagos", -22, 3, 869, 12
end
TimeZone::Register.country "IQ", "Iraq" do |c|
  c.timezone "Asia/Baghdad", 667, 20, 533, 12
end
TimeZone::Register.country "IR", "Iran" do |c|
  c.timezone "Asia/Tehran", 107, 3, 1543, 30
end
TimeZone::Register.country "IS", "Iceland" do |c|
  c.timezone "Atlantic/Reykjavik", 1283, 20, -437, 20
end
TimeZone::Register.country "IT", "Italy" do |c|
  c.timezone "Europe/Rome", 419, 10, 749, 60
end
TimeZone::Register.country "JE", "Jersey" do |c|
  c.timezone "Europe/London", 6181, 120, -451, 3600
end
TimeZone::Register.country "JM", "Jamaica" do |c|
  c.timezone "America/Jamaica", 12937, 720, -11519, 150
end
TimeZone::Register.country "JO", "Jordan" do |c|
  c.timezone "Asia/Amman", 639, 20, 539, 15
end
TimeZone::Register.country "JP", "Japan" do |c|
  c.timezone "Asia/Tokyo", 32089, 900, 503081, 3600
end
TimeZone::Register.country "KE", "Kenya" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "KG", "Kyrgyzstan" do |c|
  c.timezone "Asia/Bishkek", 429, 10, 373, 5
end
TimeZone::Register.country "KH", "Cambodia" do |c|
  c.timezone "Asia/Bangkok", 55, 4, 6031, 60, "Indochina (most areas)"
end
TimeZone::Register.country "KI", "Kiribati" do |c|
...
TimeZone::Register.country "KM", "Comoros" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "KN", "St Kitts & Nevis" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "KP", "Korea (North)" do |c|
  c.timezone "Asia/Pyongyang", 2341, 60, 503, 4
end
TimeZone::Register.country "KR", "Korea (South)" do |c|
  c.timezone "Asia/Seoul", 751, 20, 3809, 30
end
TimeZone::Register.country "KW", "Kuwait" do |c|
  c.timezone "Asia/Riyadh", 739, 30, 2803, 60
end
TimeZone::Register.country "KY", "Cayman Islands" do |c|
  c.timezone "America/Panama", 269, 30, -1193, 15
end
TimeZone::Register.country "KZ", "Kazakhstan" do |c|
...
TimeZone::Register.country "LA", "Laos" do |c|
  c.timezone "Asia/Bangkok", 55, 4, 6031, 60, "Indochina (most areas)"
end
TimeZone::Register.country "LB", "Lebanon" do |c|
  c.timezone "Asia/Beirut", 2033, 60, 71, 2
end
TimeZone::Register.country "LC", "St Lucia" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "LI", "Liechtenstein" do |c|
  c.timezone "Europe/Zurich", 2843, 60, 128, 15, "Swiss time"
end
TimeZone::Register.country "LK", "Sri Lanka" do |c|
  c.timezone "Asia/Colombo", 104, 15, 1597, 20
end
TimeZone::Register.country "LR", "Liberia" do |c|
  c.timezone "Africa/Monrovia", 63, 10, -647, 60
end
TimeZone::Register.country "LS", "Lesotho" do |c|
  c.timezone "Africa/Johannesburg", -105, 4, 28, 1
end
TimeZone::Register.country "LT", "Lithuania" do |c|
  c.timezone "Europe/Vilnius", 3281, 60, 1519, 60
end
TimeZone::Register.country "LU", "Luxembourg" do |c|
  c.timezone "Europe/Luxembourg", 248, 5, 123, 20
end
TimeZone::Register.country "LV", "Latvia" do |c|
  c.timezone "Europe/Riga", 1139, 20, 241, 10
end
TimeZone::Register.country "LY", "Libya" do |c|
  c.timezone "Africa/Tripoli", 329, 10, 791, 60
end
TimeZone::Register.country "MA", "Morocco" do |c|
  c.timezone "Africa/Casablanca", 673, 20, -91, 12
end
TimeZone::Register.country "MC", "Monaco" do |c|
  c.timezone "Europe/Monaco", 437, 10, 443, 60
end
TimeZone::Register.country "MD", "Moldova" do |c|
  c.timezone "Europe/Chisinau", 47, 1, 173, 6
end
TimeZone::Register.country "ME", "Montenegro" do |c|
  c.timezone "Europe/Belgrade", 269, 6, 41, 2
end
TimeZone::Register.country "MF", "St Martin (French)" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "MG", "Madagascar" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "MH", "Marshall Islands" do |c|
  c.timezone "Pacific/Majuro", 143, 20, 856, 5, "Marshall Islands (most areas)"
  c.timezone "Pacific/Kwajalein", 109, 12, 502, 3, "Kwajalein"
end
TimeZone::Register.country "MK", "Macedonia" do |c|
  c.timezone "Europe/Belgrade", 269, 6, 41, 2
end
TimeZone::Register.country "ML", "Mali" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "MM", "Myanmar (Burma)" do |c|
  c.timezone "Asia/Yangon", 1007, 60, 577, 6
end
TimeZone::Register.country "MN", "Mongolia" do |c|
...
TimeZone::Register.country "MO", "Macau" do |c|
  c.timezone "Asia/Macau", 667, 30, 1363, 12
end
TimeZone::Register.country "MP", "Northern Mariana Islands" do |c|
  c.timezone "Pacific/Guam", 202, 15, 579, 4
end
TimeZone::Register.country "MQ", "Martinique" do |c|
  c.timezone "America/Martinique", 73, 5, -733, 12
end
TimeZone::Register.country "MR", "Mauritania" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "MS", "Montserrat" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "MT", "Malta" do |c|
  c.timezone "Europe/Malta", 359, 10, 871, 60
end
TimeZone::Register.country "MU", "Mauritius" do |c|
  c.timezone "Indian/Mauritius", -121, 6, 115, 2
end
TimeZone::Register.country "MV", "Maldives" do |c|
  c.timezone "Indian/Maldives", 25, 6, 147, 2
end
TimeZone::Register.country "MW", "Malawi" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
TimeZone::Register.country "MX", "Mexico" do |c|
...
TimeZone::Register.country "MY", "Malaysia" do |c|
  c.timezone "Asia/Kuala_Lumpur", 19, 6, 1017, 10, "Malaysia (peninsula)"
  c.timezone "Asia/Kuching", 31, 20, 331, 3, "Sabah, Sarawak"
end
TimeZone::Register.country "MZ", "Mozambique" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
TimeZone::Register.country "NA", "Namibia" do |c|
  c.timezone "Africa/Windhoek", -677, 30, 171, 10
end
TimeZone::Register.country "NC", "New Caledonia" do |c|
  c.timezone "Pacific/Noumea", -334, 15, 3329, 20
end
TimeZone::Register.country "NE", "Niger" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "NF", "Norfolk Island" do |c|
  c.timezone "Pacific/Norfolk", -581, 20, 5039, 30
end
TimeZone::Register.country "NG", "Nigeria" do |c|
  c.timezone "Africa/Lagos", 129, 20, 17, 5, "West Africa Time"
end
TimeZone::Register.country "NI", "Nicaragua" do |c|
  c.timezone "America/Managua", 243, 20, -5177, 60
end
TimeZone::Register.country "NL", "Netherlands" do |c|
  c.timezone "Europe/Amsterdam", 1571, 30, 49, 10
end
TimeZone::Register.country "NO", "Norway" do |c|
  c.timezone "Europe/Oslo", 719, 12, 43, 4
end
TimeZone::Register.country "NP", "Nepal" do |c|
  c.timezone "Asia/Kathmandu", 1663, 60, 5119, 60
end
TimeZone::Register.country "NR", "Nauru" do |c|
  c.timezone "Pacific/Nauru", -31, 60, 2003, 12
end
TimeZone::Register.country "NU", "Niue" do |c|
  c.timezone "Pacific/Niue", -1141, 60, -2039, 12
end
TimeZone::Register.country "NZ", "New Zealand" do |c|
  c.timezone "Pacific/Auckland", -553, 15, 5243, 30, "New Zealand time"
  c.timezone "Pacific/Chatham", -879, 20, -3531, 20, "Chatham Islands"
end
TimeZone::Register.country "OM", "Oman" do |c|
  c.timezone "Asia/Dubai", 253, 10, 553, 10
end
TimeZone::Register.country "PA", "Panama" do |c|
  c.timezone "America/Panama", 269, 30, -1193, 15
end
TimeZone::Register.country "PE", "Peru" do |c|
  c.timezone "America/Lima", -241, 20, -1541, 20
end
TimeZone::Register.country "PF", "French Polynesia" do |c|
...
TimeZone::Register.country "PG", "Papua New Guinea" do |c|
...
TimeZone::Register.country "PH", "Philippines" do |c|
  c.timezone "Asia/Manila", 175, 12, 121, 1
end
TimeZone::Register.country "PK", "Pakistan" do |c|
  c.timezone "Asia/Karachi", 373, 15, 1341, 20
end
TimeZone::Register.country "PL", "Poland" do |c|
  c.timezone "Europe/Warsaw", 209, 4, 21, 1
end
TimeZone::Register.country "PM", "St Pierre & Miquelon" do |c|
  c.timezone "America/Miquelon", 941, 20, -169, 3
end
TimeZone::Register.country "PN", "Pitcairn" do |c|
  c.timezone "Pacific/Pitcairn", -376, 15, -1561, 12
end
TimeZone::Register.country "PR", "Puerto Rico" do |c|
  c.timezone "America/Puerto_Rico", 11081, 600, -118991, 1800
end
TimeZone::Register.country "PS", "Palestine" do |c|
  c.timezone "Asia/Gaza", 63, 2, 517, 15, "Gaza Strip"
  c.timezone "Asia/Hebron", 473, 15, 7019, 200, "West Bank"
end
TimeZone::Register.country "PT", "Portugal" do |c|
...
TimeZone::Register.country "PW", "Palau" do |c|
  c.timezone "Pacific/Palau", 22, 3, 8069, 60
end
TimeZone::Register.country "PY", "Paraguay" do |c|
  c.timezone "America/Asuncion", -379, 15, -173, 3
end
TimeZone::Register.country "QA", "Qatar" do |c|
  c.timezone "Asia/Qatar", 1517, 60, 773, 15
end
TimeZone::Register.country "RE", "Réunion" do |c|
  c.timezone "Indian/Reunion", -313, 15, 832, 15, "Réunion, Crozet, Scattered Islands"
end
TimeZone::Register.country "RO", "Romania" do |c|
  c.timezone "Europe/Bucharest", 1333, 30, 261, 10
end
TimeZone::Register.country "RS", "Serbia" do |c|
  c.timezone "Europe/Belgrade", 269, 6, 41, 2
end
TimeZone::Register.country "RU", "Russia" do |c|
...
TimeZone::Register.country "RW", "Rwanda" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
TimeZone::Register.country "SA", "Saudi Arabia" do |c|
  c.timezone "Asia/Riyadh", 739, 30, 2803, 60
end
TimeZone::Register.country "SB", "Solomon Islands" do |c|
  c.timezone "Pacific/Guadalcanal", -143, 15, 801, 5
end
TimeZone::Register.country "SC", "Seychelles" do |c|
  c.timezone "Indian/Mahe", -14, 3, 832, 15
end
TimeZone::Register.country "SD", "Sudan" do |c|
  c.timezone "Africa/Khartoum", 78, 5, 488, 15
end
TimeZone::Register.country "SE", "Sweden" do |c|
  c.timezone "Europe/Stockholm", 178, 3, 361, 20
end
TimeZone::Register.country "SG", "Singapore" do |c|
  c.timezone "Asia/Singapore", 77, 60, 2077, 20
end
TimeZone::Register.country "SH", "St Helena" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "SI", "Slovenia" do |c|
  c.timezone "Europe/Belgrade", 269, 6, 41, 2
end
TimeZone::Register.country "SJ", "Svalbard & Jan Mayen" do |c|
  c.timezone "Europe/Oslo", 719, 12, 43, 4
end
TimeZone::Register.country "SK", "Slovakia" do |c|
  c.timezone "Europe/Prague", 601, 12, 433, 30
end
TimeZone::Register.country "SL", "Sierra Leone" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "SM", "San Marino" do |c|
  c.timezone "Europe/Rome", 419, 10, 749, 60
end
TimeZone::Register.country "SN", "Senegal" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "SO", "Somalia" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "SR", "Suriname" do |c|
  c.timezone "America/Paramaribo", 35, 6, -331, 6
end
TimeZone::Register.country "SS", "South Sudan" do |c|
...
TimeZone::Register.country "SX", "St Maarten (Dutch)" do |c|
  c.timezone "America/Curacao", 731, 60, -69, 1
end
TimeZone::Register.country "SY", "Syria" do |c|
  c.timezone "Asia/Damascus", 67, 2, 363, 10
end
TimeZone::Register.country "SZ", "Swaziland" do |c|
  c.timezone "Africa/Johannesburg", -105, 4, 28, 1
end
TimeZone::Register.country "TC", "Turks & Caicos Is" do |c|
  c.timezone "America/Grand_Turk", 322, 15, -1067, 15
end
TimeZone::Register.country "TD", "Chad" do |c|
  c.timezone "Africa/Ndjamena", 727, 60, 301, 20
end
TimeZone::Register.country "TF", "French Southern & Antarctic Lands" do |c|
  c.timezone "Indian/Kerguelen", -17767, 360, 28087, 400, "Kerguelen, St Paul Island, Amsterdam Island"
  c.timezone "Indian/Reunion", -313, 15, 832, 15, "Réunion, Crozet, Scattered Islands"
end
TimeZone::Register.country "TG", "Togo" do |c|
  c.timezone "Africa/Abidjan", 319, 60, -121, 30
end
TimeZone::Register.country "TH", "Thailand" do |c|
  c.timezone "Asia/Bangkok", 55, 4, 6031, 60, "Indochina (most areas)"
end
TimeZone::Register.country "TJ", "Tajikistan" do |c|
  c.timezone "Asia/Dushanbe", 463, 12, 344, 5
end
TimeZone::Register.country "TK", "Tokelau" do |c|
  c.timezone "Pacific/Fakaofo", -281, 30, -5137, 30
end
TimeZone::Register.country "TL", "East Timor" do |c|
  c.timezone "Asia/Dili", -171, 20, 1507, 12
end
TimeZone::Register.country "TM", "Turkmenistan" do |c|
  c.timezone "Asia/Ashgabat", 759, 20, 3503, 60
end
TimeZone::Register.country "TN", "Tunisia" do |c|
  c.timezone "Africa/Tunis", 184, 5, 611, 60
end
TimeZone::Register.country "TO", "Tonga" do |c|
  c.timezone "Pacific/Tongatapu", -127, 6, -1051, 6
end
TimeZone::Register.country "TR", "Turkey" do |c|
  c.timezone "Europe/Istanbul", 2461, 60, 869, 30
end
TimeZone::Register.country "TT", "Trinidad & Tobago" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "TV", "Tuvalu" do |c|
  c.timezone "Pacific/Funafuti", -511, 60, 10753, 60
end
TimeZone::Register.country "TW", "Taiwan" do |c|
  c.timezone "Asia/Taipei", 501, 20, 243, 2
end
TimeZone::Register.country "TZ", "Tanzania" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "UA", "Ukraine" do |c|
...
TimeZone::Register.country "UG", "Uganda" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "UM", "US minor outlying islands" do |c|
  c.timezone "Pacific/Wake", 1157, 60, 9997, 60, "Wake Island"
  c.timezone "Pacific/Pago_Pago", -214, 15, -1707, 10, "Samoa, Midway"
  c.timezone "Pacific/Honolulu", 15341, 720, -18943, 120, "Hawaii"
end
TimeZone::Register.country "US", "United States" do |c|
...
TimeZone::Register.country "VA", "Vatican City" do |c|
  c.timezone "Europe/Rome", 419, 10, 749, 60
end
TimeZone::Register.country "VC", "St Vincent" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "VE", "Venezuela" do |c|
  c.timezone "America/Caracas", 21, 2, -1004, 15
end
TimeZone::Register.country "VG", "Virgin Islands (UK)" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "VI", "Virgin Islands (US)" do |c|
  c.timezone "America/Port_of_Spain", 213, 20, -3691, 60
end
TimeZone::Register.country "VN", "Vietnam" do |c|
  c.timezone "Asia/Ho_Chi_Minh", 43, 4, 320, 3, "Vietnam (south)"
  c.timezone "Asia/Bangkok", 55, 4, 6031, 60, "Indochina (most areas)"
end
TimeZone::Register.country "VU", "Vanuatu" do |c|
  c.timezone "Pacific/Efate", -53, 3, 2021, 12
end
TimeZone::Register.country "WF", "Wallis & Futuna" do |c|
  c.timezone "Pacific/Wallis", -133, 10, -1057, 6
end
TimeZone::Register.country "WS", "Samoa (western)" do |c|
  c.timezone "Pacific/Apia", -83, 6, -2576, 15
end
TimeZone::Register.country "YE", "Yemen" do |c|
  c.timezone "Asia/Riyadh", 739, 30, 2803, 60
end
TimeZone::Register.country "YT", "Mayotte" do |c|
  c.timezone "Africa/Nairobi", -77, 60, 2209, 60
end
TimeZone::Register.country "ZA", "South Africa" do |c|
  c.timezone "Africa/Johannesburg", -105, 4, 28, 1
end
TimeZone::Register.country "ZM", "Zambia" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
TimeZone::Register.country "ZW", "Zimbabwe" do |c|
  c.timezone "Africa/Maputo", -779, 30, 391, 12, "Central Africa Time"
end
