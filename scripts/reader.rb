# Original source: https://github.com/tzinfo/tzinfo-data/blob/master/lib/tzinfo/data/tzdataparser.rb
# Created by: Philip Ross
# Modified by: Kalnytskyi Roman
...
module TZInfo
  module Data
    ...
    class TZDataParser
      ...
      private     
        ...
        def write_timezones_index
          ...
          open_file(File.join(dir, 'timezones.cr'), 'w', :external_encoding => 'UTF-8', :universal_newline => true) do |file|
            break
    ...
    class TZDataCountry #:nodoc:
      ...
      def write_index_record(file)
        s = "TimeZone::Register.country #{quote_str(@code)}, #{quote_str(@name)} do |c|"
